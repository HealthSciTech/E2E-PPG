...
def PPG_Peak(signal, sampling_freq, fc, order, btype, seconds, overlap, minlen):
  '''
  ...
  segmentized_signal = splitSignal(filtered_signal, 100, seconds, overlap, minlen)
  ...
  return segmentized_signal, indeces
